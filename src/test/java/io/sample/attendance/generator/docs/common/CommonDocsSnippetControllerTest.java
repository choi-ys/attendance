...
public class CommonDocsSnippetControllerTest extends SpringBootTestBase {
    ...
    public void commonPaginationResponse() throws Exception {
        ...
        // Then
        공통_페이징_응답_구조_응답_검증(공통_페이징_응답_구조_조회_응답);
    ...
    private void 공통_페이징_응답_구조_응답_검증(ResultActions 공통_페이징_응답_구조_조회_응답) throws Exception {
        공통_페이징_응답_구조_조회_응답.andExpect(status().isOk());
    }
